	...
	<view style="background: #FBFCFE;height: 100%;position: absolute;width: 100%;">
		<view style="margin-top: 80px;padding: 10px;margin: 20px 15px;">
			<u--form labelPosition="left" :model="model1" :rules="rules" ref="form1">
				<u-form-item labelWidth="90" label="旧登陆密码" prop="userInfo.oldPwd" borderBottom ref="item2">
					<u--input v-model="model1.userInfo.oldPwd" type="password" border="none"
						placeholder="长度在8-18个字母或数字"></u--input>
				</u-form-item>
				<u-form-item labelWidth="90" label="新登陆密码" prop="userInfo.newPwd" borderBottom ref="item2">
					<u--input v-model="model1.userInfo.newPwd" type="password" border="none"
						placeholder="长度在8-18个字母或数字"></u--input>
				</u-form-item>
			</u--form>
