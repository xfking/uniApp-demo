	...
	<view>
		...
		<view style="background: #fff;padding: 10px 15px;">
			<view style="display: flex;align-items: center;">
				<view>
					<u--image :showLoading="true" :src="params.url||src" width="80px" height="80px">
					</u--image>
				</view>
				<view style="line-height: 1.8;margin-left: 15px;">
					<view style="display: flex;align-items: center;">
						<view style="font-size: 17px;font-weight: bold;margin-right: 8px;">{{params.goodsName||'随机'}}</view>
					</view>
					<view style="display: flex;font-size: 12px;">
						<view style="margin-right: 15px;">已售：{{params.sold}}</view>
					</view>
					<view style="display: flex;font-size: 12px;align-items: center;justify-content: space-between;">
						<view style="margin-right: 15px;">购买数量：</view>
						<view style="">{{params.number}}</view>
					</view>
				</view>
			</view>
		</view>
