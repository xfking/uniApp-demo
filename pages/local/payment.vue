	...
	<view>
		...
		<view style="background: #fff;padding: 10px 15px;">
			<view style="display: flex;align-items: center;">
				<view>
					<u--image :showLoading="true" shape="circle" :src="params.url||src" width="60px" height="60px">
					</u--image>
				</view>
				<view style="line-height: 1.8;margin-left: 15px;">
					...
					<view style="display: flex;font-size: 12px;">
						<view style="margin-right: 15px;">服务类型：{{params.serviceType}}</view>
						<view style="flex:1">时长：{{params.serviceTime}}</view>
					</view>
					<view style="display: flex;font-size: 12px;">
						<view style="margin-right: 15px;">服务名称：{{params.zTypeName}}</view>
						<view style="flex:1">服务级别：{{params.cTypeName}}</view>
					</view>
				</view>
			</view>
		</view>
		...
		<view style="background: #fff;padding: 12px 15px;display: flex;align-items: center;">
			<view style="margin-right: 10px;">微信号</view>
			<view>
				<u--input placeholder="请输入微信号" border="none" v-model="wxNumber"></u--input>
			</view>
		</view>
		<u-gap bgColor="transparent" height="10"></u-gap>
		<view style="background: #fff;padding: 12px 15px;display: flex;align-items: center;">
			<view style="margin-right: 10px;">手机号</view>
			<view>
				<u--input placeholder="请输入手机号" border="none" v-model="phone"></u--input>
			</view>
		</view>
		<u-gap bgColor="transparent" height="10"></u-gap>
		<view style="background: #fff;padding: 12px 15px;display: flex;align-items: center;">
			<view style="margin-right: 10px;">所在地</view>
			<view style="display:flex;flex:1" @click="getLoaction()">
				<!-- <u--input placeholder="请输入所在地" border="none" v-model="address"></u--input> -->
				<u--input placeholder="请选择所在地" border="none" v-model="address" readonly></u--input>
